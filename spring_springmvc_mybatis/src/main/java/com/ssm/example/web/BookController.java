...
import com.ssm.common.dto.Result;
...
public class BookController {
	...
	private String list(HttpServletRequest request,ModelMap model) {
		List<Book> list = bookService.getList();
		model.addAttribute("list", list);
		return "example/book/book_list";// WEB-INF/view/example/book/book_list.html
	}
